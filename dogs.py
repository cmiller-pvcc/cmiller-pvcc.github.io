...
dogs = ["Sadie","Molly", "Ella", "Buddy", "Rocky", "AnnaBelle",
...
def main():
    ...
    print(dogs)
    print(doggy + " was removed from the front o fthe list.")
    
    another_dog = dogs.pop (3)
    print("\nNote:Position numbers in a list begin with O, not with l")
    ...
    print("\nRemove a dog be name rather than position in the list:")
    print(dogs)
