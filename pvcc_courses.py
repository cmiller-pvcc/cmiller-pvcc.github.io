...
def process_info_courses():
    #student adds code for processing info
     global info_elect
...
def display_info_courses():
    #student add code for printing info
     global out
     out.write("\nASSOCIATE DEGREE: Information Technology")
     out.write(dash_line)
     out.write("Number of required courses   : " + str(num_info_req))
     out.write("Number of elective courses   : " + str(num_info_elect))
     out.write("Total number of AAS courses  : " + str(tot_info))
     out.write(dash_line)
     out.write("All AAS courses: ")
     num = 1
